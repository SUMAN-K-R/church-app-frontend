...
class UserProfileRegisterPage extends StatefulWidget {
  final int userId;

  UserProfileRegisterPage({required this.userId});

  @override
  _UserProfileRegisterPage createState() => _UserProfileRegisterPage();
}

class _UserProfileRegisterPage extends State<UserProfileRegisterPage> {
